...
$(document).ready(function(){
	...
	function load_images(){
		...
		for(i=1; i<9; i++){
			x = i-1;
			document.getElementById("img" + i).src ="assets/images/birds_images/" + randObjects[x] + ".png";
			document.getElementById("imgdrag"+ i).src = "assets/images/birds_names/" + randOptions[x] +".png";
		}
	}
   ...
   $('#gameArea #imageArea').bind('dragenter', function(ev) {  // Update the drop zone class on drag enter/leave
       ...
       .bind('drop', function(ev) {
          ...
          if(droppedOptionBox == selectedOptionBox){
        	   document.getElementById("imgdrop"+dropPosition+"").src = "assets/images/birds_names/"+selectedOptionBox+".png";
   ...
   $('#optionArea').bind('dragenter', function(ev) {  // Update the drop zone class on drag enter/leave
		
       if (!$(ev.target).hasClass('dragImg')) return true;
           $(ev.target).addClass('dragover');  return false;
       })
